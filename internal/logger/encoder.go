...
func NewModulariseEncoder() zapcore.Encoder {
	return modulariseEncoder{
		Encoder:       zapcore.NewConsoleEncoder(fieldEncoderConfig),
		EncoderConfig: externalEncoderConfig,
	}
}

type modulariseEncoder struct {
	zapcore.Encoder
	zapcore.EncoderConfig
}

func (c modulariseEncoder) EncodeEntry(ent zapcore.Entry, fields []zapcore.Field) (*buffer.Buffer, error) {
	line := pool.Get()
